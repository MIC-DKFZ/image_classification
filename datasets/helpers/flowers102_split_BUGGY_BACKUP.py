#!/usr/bin/env python3
"""
Create splits.json for Flowers-102 dataset.

Flowers-102 has train/valid/test folders with class subfolders.
We'll merge train and valid, then create our own 60/20/20 splits.
"""
...
def main():
    ...
    # Collect all images from train, valid, test folders
    image_data = []
    ...
    for split_name in ["train", "valid", "test"]:
        ...
        for class_dir in split_dir.iterdir():
            ...
            for img_path in class_dir.iterdir():
                ...
                # Store as relative path from dataset_dir
