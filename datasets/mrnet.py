...
class MRNetDataModule(BaseDataModule):
    def __init__(self, **params):
        super(MRNetDataModule, self).__init__(**params)

    def setup(self, stage: str):

        self.train_dataset = MRNetData(
            self.data_path,
            split="train",
            transform=self.train_transforms,
            fold=self.fold,
        )
        self.val_dataset = MRNetData(
            self.data_path,
            split="val",
