...
if __name__ == '__main__':
    ...
    parser.add_argument('--random_batches', action='store_true',
    ...
    parser.add_argument('--exp_dir', default=os.environ['EXPERIMENT_LOCATION'] if 'EXPERIMENT_LOCATION' in os.environ.keys() else './experiments',
                        help='Location where MLflow logs should be saved in local environment')
    # Checkpoint saving
    parser.add_argument('--save_model', action='store_true', help='Saves the model checkpoint after training in the exp_dir')
    parser.add_argument('--chpt_name', default='', help='Name of the checkpoint file, if not specified it will use the model name, epoch and test metrics')
    # Environment
