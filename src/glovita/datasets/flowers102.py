...
if __name__ == '__main__':
    ...
    from glovita.augmentation.policies.dataset_specific.flowers102 import build_test_transform, build_train_transform

    # Get DATA_ROOT from environment or use default
    data_root = os.environ.get("DATA_ROOT", "./data")

    print("="*80)
    print("Testing Flowers102 Dataset")
    ...
    train_ds = Flowers102Data(root=f"{data_root}/Flowers102", split="train", transform=train_aug)
    ...
    val_ds = Flowers102Data(root=f"{data_root}/Flowers102", split="val", transform=val_aug)
    ...
    print("\n" + "="*80)
    print("✓ Flowers102 Dataset test completed successfully!")
    print("="*80)
