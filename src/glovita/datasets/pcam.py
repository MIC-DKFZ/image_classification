...
class PCamData(Dataset):
    def __init__(
        ...
        """
        PCam (PatchCamelyon) dataset loader.
        ...
        Folder layout:
            root/
              images/
                ...
                test_000000.png
                ...
              labels.json       {"train_000000.png": 0, ...}
...
if __name__ == '__main__':
    ...
    from glovita.augmentation.policies.dataset_specific.pcam import build_test_transform, build_train_transform
    ...
    train_ds = PCamData(root=f"{data_root}/PCam", split="train", transform=train_aug)
    ...
    val_ds = PCamData(root=f"{data_root}/PCam", split="val", transform=val_aug)
    ...
    print("\n" + "="*80)
    print("✓ PCam Dataset test completed successfully!")
    print("="*80)
