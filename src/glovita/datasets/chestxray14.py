        ...
        Folder layout:
            root/
              images/
                ...
                00000001_001.png
                ...
              labels.json       {"00000001_000.png": 0, ...}
...
if __name__ == '__main__':
    ...
    from glovita.augmentation.policies.dataset_specific.chestxray14 import build_test_transform, build_train_transform

    # Get DATA_ROOT from environment or use default
    data_root = os.environ.get("DATA_ROOT", "./data")

    print("="*80)
    print("Testing ChestXray14 Dataset")
    ...
    train_ds = ChestXray14Data(root=f"{data_root}/ChestXray14", split="train", transform=train_aug)
    ...
    val_ds = ChestXray14Data(root=f"{data_root}/ChestXray14", split="val", transform=val_aug)
    ...
    print("\n" + "="*80)
    print("✓ ChestXray14 Dataset test completed successfully!")
    print("="*80)
