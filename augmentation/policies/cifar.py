...
def get_baseline_cutout(cutout_size: int) -> transforms.Compose:
...
def get_auto_augmentation(cutout_size: int) -> transforms.Compose:
...
def get_rand_augmentation(cutout_size: int) -> transforms.Compose:
