...
def apply_peft(model: nn.Module, config: PeftConfig) -> nn.Module:
    ...
    if isinstance(config, LinearProbingConfig):
        ...
        from models.peft.ssf import SSF as SSFMixin
        SSFMixin.__init__(model)

    elif isinstance(config, DiffFitConfig):
        from models.peft.difffit import DiffFit as DiffFitMixin
        DiffFitMixin.__init__(model)

    elif isinstance(config, LoraConfig):
        from models.peft.lora import LoRA as LoRAMixin
        LoRAMixin.__init__(
            model,
        ...
        from models.peft.adalora import AdaLoRA as AdaLoRAMixin
        ...
        from models.peft.loha import LoHa as LoHaMixin
        LoHaMixin.__init__(
            model,
        ...
        from models.peft.lokr import LoKr as LoKrMixin
        LoKrMixin.__init__(
            model,
        ...
        from models.peft.oft import OFT as OFTMixin
        OFTMixin.__init__(
            model,
            oft_r=config.oft_r,
        ...
        from models.peft.boft import BOFT as BOFTMixin
        BOFTMixin.__init__(
            model,
        ...
        from models.peft.vera import Vera as VeraMixin
        VeraMixin.__init__(
            model,
        ...
        from models.peft.ia3 import IA3 as IA3Mixin
        IA3Mixin.__init__(model)

    elif isinstance(config, FourierFTConfig):
        from models.peft.fourierft import FourierFT as FourierFTMixin
        ...
        from models.peft.adapt_former import AdaptFormer as AdaptFormerMixin
        ...
        from models.peft.convpass import Convpass as ConvpassMixin
        ...
        from models.peft.rep_adapter import RepAdapter as RepAdapterMixin
