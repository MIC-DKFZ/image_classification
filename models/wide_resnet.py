...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 base_width=64, dilation=1, norm_layer=None, stochastic_depth=0.0, apply_se=False, p_shakedrop=None):
...
class ResNet(BaseModel):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample,
                            self.base_width, previous_dilation, norm_layer, self.stochastic_depth, self.se, self.ps_shakedrop[self.u_idx]))
        ...
        for _ in range(1, blocks):
            layers.append(block(self.inplanes, planes,
                                ...
                                norm_layer=norm_layer, stochastic_depth=self.stochastic_depth, apply_se=self.se,
